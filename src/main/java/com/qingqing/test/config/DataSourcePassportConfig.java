...
}, sqlSessionFactoryRef = DataSourcePassportConfig.SQL_SESSION_FACTORY)
public class DataSourcePassportConfig {

    public final static String DATA_SOURCE_NAME = "qq_passport";
    public final static String SQL_SESSION_FACTORY = "sqlPassportSessionFactory";
    public final static String TX_MANAGER = "passportTransactionManager";

    private static String validation_query = "SELECT 1 FROM DUAL";

    private static final Logger logger = LoggerFactory.getLogger(DataSourcePassportConfig.class);
