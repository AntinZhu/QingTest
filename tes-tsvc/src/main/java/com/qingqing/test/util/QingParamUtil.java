...
import com.qingqing.api.proto.v1.UserProto.SimpleQingqingTeacherStudentIdPairRequest;
...
//        System.out.println(generateParamJson(Class.forName(TeachingTimeAndClassTimeRequest.class.getName()), ""));
        System.out.println(generateParamJson(SimpleQingqingTeacherStudentIdPairRequest.class.getName()));
