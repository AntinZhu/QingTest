...
import com.qingqing.api.proto.v1.adjust.ReadjustOrderCourse.ReadjustOrderCourseApplyRequest;
...
//        System.out.println(generateParamJson(Class.forName(TeachingTimeAndClassTimeRequest.class.getName()), ""));
        System.out.println(generateParamJson(ReadjustOrderCourseApplyRequest.class.getName()));
