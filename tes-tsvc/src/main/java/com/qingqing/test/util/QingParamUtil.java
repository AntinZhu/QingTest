...
import com.qingqing.api.proto.v1.course.OrderCourse.ApiOrderCourseProtocolDownloadRequest;
...
//        System.out.println(generateParamJson(Class.forName(TeachingTimeAndClassTimeRequest.class.getName()), ""));
        System.out.println(generateParamJson(ApiOrderCourseProtocolDownloadRequest.class.getName()));
