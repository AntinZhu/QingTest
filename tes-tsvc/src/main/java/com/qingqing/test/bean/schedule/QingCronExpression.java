 ...
 */
public class QingCronExpression {
     ...
     */
    public QingCronExpression(String cronExpression) throws ParseException {
     ...
     */
    public QingCronExpression(QingCronExpression expression) {
        /*
    ...
    public static boolean isValidExpression(String cronExpression) {
        ...
        try {
            new QingCronExpression(cronExpression);
    ...
    @Deprecated
    public Object clone() {
        return new QingCronExpression(this);
    }
