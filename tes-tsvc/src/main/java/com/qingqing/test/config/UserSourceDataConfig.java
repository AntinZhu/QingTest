...
@MapperScan(basePackages = {
        "com.qingqing.test.dao.user",
}, sqlSessionFactoryRef = UserSourceDataConfig.SQL_SESSION_FACTORY)
public class UserSourceDataConfig {

    public final static String DATA_SOURCE_NAME = "qq_user";
    ...
    private static final Logger logger = LoggerFactory.getLogger(UserSourceDataConfig.class);
