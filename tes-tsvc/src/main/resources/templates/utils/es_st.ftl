                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small>
                                ...
                                <label id = "interfaceNameDiv">修改bi_teacher_index中的数据</label>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                        ...
                        <div class="form-actions">
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" id="studentId" placeholder="家长ID" class="col-xs-10 col-sm-5" />
                                    </div>
                                </div>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        function searchStudent(studentId){
            ...
            commonAjaxRequest("${base}/v1/utils/es/student/" + studentId, data, handleSearch, false, "查询接口信息出错:", $("#env").val());
        }
...
//            alert(resu.resultList);
            ...
            var modifyLength = modifyArr.length;
...
//                        }
        ...
        $("#updateBtn").click(function () {
            ...
            var data = {
                studentId : indexInfo._id,
                indexName : indexInfo._index,
                data : JSON.stringify(fullData)
            }

            commonAjaxRequest("${base}/v1/utils/es/student/update", data, handleUpdate, false, "更新索引数据错误:");
        });
